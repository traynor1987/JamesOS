...
object JamesCalibrationCatalog {
    private val registrations=listOf(
        ...
        CalibrationRegistration("life_balance",true,"Life for myself",10,false,listOf(outputBias)),
